...
\begin{observation}
	For a flower since the stem is an even augmenting path the base of the blossom is even as well as all the other vertices of the blossom are even.
\end{observation}
