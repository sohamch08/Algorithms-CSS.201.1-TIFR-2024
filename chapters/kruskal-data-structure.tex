...
\begin{algorithm}[]
	...
	\Else{
		...
		$u.\emph{rank}\longleftarrow u.\emph{rank}+1$
	}
\end{algorithm}
...
\begin{lemma}{}{}
	Once a node stops being a {leader} (i.e. the node in top of a tree). It can never become a leader again.
\end{lemma}
\begin{proof}
...
\end{proof}
\begin{lemma}{}{}
	Once a node stops being a leader then its rank is fixed.
\end{lemma}
\begin{proof}
