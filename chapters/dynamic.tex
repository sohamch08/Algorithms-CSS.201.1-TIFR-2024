...
\dfnc[dynamic-prog]{Dynamic Programming}{Dynamic Programming has 3 components:\begin{enumerate}
		...
		\item {Table Filling}: Use a table to store the result of solving smaller independent problems.
\end{enumerate}}
